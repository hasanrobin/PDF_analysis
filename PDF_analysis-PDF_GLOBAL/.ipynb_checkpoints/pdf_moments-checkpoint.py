...
if __name__=='__main__':
    ...
    fitcurve =["skewnorm","weib", "laplace"] 
    ...
    exp_out_dir= '/work/cmcc/mg13420/plot_exercises/sst_pdf-exps/'   # Change the path/dir to local dir
    ...
    input_pdf = exp_var_path +"/"+"pdfParm_{}_{}_2022_2023.nc".format(var_name, fitcurve[0] )
   
    with xr.open_dataset(input_pdf) as ds0:
        #print(ds0)
        longitude= ds0.variables["longitude"]
        latitude= ds0.variables["latitude"]
        crd_lon= longitude
        crd_lat = latitude 
        nlat=  len(latitude)
        nlon = len(longitude)
    ...
    # output moment file
    file_pdfMom = "fitmom_{}_{}_2022_2023.nc".format(var_name, fitcurve[0])
    print(input_pdf) 
